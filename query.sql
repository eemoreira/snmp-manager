...
-- Assumimos que o IP 10.90.90.51 está conectado na Porta 1 do Switch.
INSERT INTO porta_switch (switch_id, porta_numero) VALUES (@switch_id, 15);
...
INSERT INTO maquina (ip, mac) VALUES ('10.90.90.50', '00:1A:2B:3C:4D:5E');
...
INSERT INTO sala_porta (sala_id, porta_switch_id, ip_maquina) 
VALUES (@sala_id, @porta_admin_id, '10.90.90.50');

-- Opcional: Adicionar uma segunda porta para testar as funções de LIGAR/DESLIGAR
INSERT INTO porta_switch (switch_id, porta_numero) VALUES (@switch_id, 5);
SET @porta_maquina_teste_id = LAST_INSERT_ID();

-- Associa uma máquina de teste na Porta 2
INSERT INTO maquina (ip, mac) VALUES ('10.90.90.52', '00:11:22:33:44:55');
SET @maquina_teste_id = LAST_INSERT_ID();
INSERT INTO sala_porta (sala_id, porta_switch_id, ip_maquina) 
VALUES (@sala_id, @porta_maquina_teste_id, '10.90.90.52');
